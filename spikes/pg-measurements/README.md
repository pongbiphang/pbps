...
| File | |
|---|---|
| `postgres.sql` | 198 measurements: modules and overloading (A), privileges (B), type-change cost (T), reference data (R) |
...
| `R1`–`R100`, `M3` | [ADR-0013](../../docs/ADR-0013-postgres-reference-data.md) — defaults, identity keys, `NOT VALID`, collation, session-dependent rendering |
