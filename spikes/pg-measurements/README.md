...
| File | |
|---|---|
| `postgres.sql` | 80 measurements: modules and overloading (A), privileges (B), type-change cost (T), reference data (R) |
...
| Lines | ADR |
|---|---|
| `A1`–`A32` | [ADR-0009](../../docs/ADR-0009-postgres-modules.md) — deparsing, overloading, what `CREATE OR REPLACE` cannot do, dependency refusals |
