...
The whole read is one `REPEATABLE READ READ ONLY` transaction (DECISIONS 248):
...
there is carried (DECISIONS 249): a partitioned or foreign table, a domain or a type the catalogue
