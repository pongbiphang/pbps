...
pins, under the environment's fingerprint key, every routine not held only
by superusers, managed or not. `apply` refuses a changed pin under the lock before
