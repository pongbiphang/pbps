...
use pbps_model::{
    Change, ChangeSet, ColumnType, Module, ObjectName, Role, Strategy, Table, TableName,
};
...
impl Dialect for Mssql {
    ...
    fn validate_role(&self, name: &str, role: &Role) -> Vec<DialectError> {
        validate::role(name, role)
    }
